...
public class AuthController {
    ...
    @PostMapping("/getSwitchAccountList")
    public DataResponse getSwitchAccountList(@Valid @RequestBody DataRequest dataRequest) {
        return authService.getSwitchAccountList(dataRequest);
    }
    @PostMapping("/switchAccount")
    public ResponseEntity<?> switchAccount(@Valid @RequestBody DataRequest dataRequest) {
        return authService.switchAccount(dataRequest);
    }
